 ...
 * @property \DRStripe\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\DRStripe\Customer $customer The ID of the customer associated with this discount.
