 ...
 * @property null|string|\DRStripe\Account|\DRStripe\AlipayAccount|\DRStripe\BankAccount|\DRStripe\BitcoinReceiver|\DRStripe\Card|\DRStripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\DRStripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \DRStripe\StripeObject $invoice_settings
 ...
 * @property null|\DRStripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \DRStripe\Collection<\DRStripe\Account|\DRStripe\AlipayAccount|\DRStripe\BankAccount|\DRStripe\BitcoinReceiver|\DRStripe\Card|\DRStripe\Source> $sources The customer's payment sources, if any.
 * @property \DRStripe\Collection<\DRStripe\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property \DRStripe\StripeObject $tax
 ...
 * @property \DRStripe\Collection<\DRStripe\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\DRStripe\TestHelpers\TestClock $test_clock ID of the test clock this customer belongs to.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \DRStripe\Customer the updated customer
     */
     ...
     *
     * @return \DRStripe\Collection<\DRStripe\PaymentMethod> list of PaymentMethods
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Customer the retrieved customer
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\SearchResult<Customer> the customer search results
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\CustomerBalanceTransaction
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\AlipayAccount|\DRStripe\BankAccount|\DRStripe\BitcoinReceiver|\DRStripe\Card|\DRStripe\Source> the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\AlipayAccount|\DRStripe\BankAccount|\DRStripe\BitcoinReceiver|\DRStripe\Card|\DRStripe\Source
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\TaxId> the list of tax ids
     */
