 ...
 * @property null|string|\DRStripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\DRStripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\DRStripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \DRStripe\StripeObject $spending_controls
 * @property string $status Whether authorizations can be approved on this card.
 * @property string $type The type of the card.
 * @property null|\DRStripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \DRStripe\ApiResource
{
     ...
     *
     * @return \DRStripe\Issuing\CardDetails the card details associated with that issuing card
     */
