 ...
 * @property null|\DRStripe\StripeObject $action The most recent action performed by the reader.
 ...
 * @property null|string|\DRStripe\Terminal\Location $location The location identifier of the reader.
 ...
 */
class Reader extends \DRStripe\ApiResource
{
    const OBJECT_NAME = 'terminal.reader';

    use \DRStripe\ApiOperations\All;
    use \DRStripe\ApiOperations\Create;
    use \DRStripe\ApiOperations\Delete;
     ...
     *
     * @return \DRStripe\Terminal\Reader the canceled reader
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Terminal\Reader the processed reader
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Terminal\Reader the seted reader
     */
