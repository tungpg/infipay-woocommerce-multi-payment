 ...
 * @property string|\DRStripe\Customer $customer ID of the customer.
 * @property null|string|\DRStripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \DRStripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\DRStripe\Invoice $invoice ID of the invoice.
 * @property \DRStripe\Collection<\DRStripe\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|string|\DRStripe\Refund $refund Refund related to this credit note.
 ...
 * @property \DRStripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \DRStripe\CreditNote the previewed credit note
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\CreditNote the voided credit note
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\CreditNoteLineItem> the list of credit note line items
     */
