 ...
 * @property \DRStripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \DRStripe\StripeObject $verification_fields
 */
