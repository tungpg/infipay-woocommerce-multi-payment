 ...
 * @property \DRStripe\StripeObject $error
 * @property null|\DRStripe\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \DRStripe\ApiResource
{
