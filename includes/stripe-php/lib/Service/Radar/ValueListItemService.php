...
namespace DRStripe\Service\Radar;

class ValueListItemService extends \DRStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \DRStripe\Collection<\DRStripe\Radar\ValueListItem>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Radar\ValueListItem
     */
