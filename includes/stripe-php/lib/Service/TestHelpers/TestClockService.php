...
class TestClockService extends \DRStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \DRStripe\TestHelpers\TestClock
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\TestHelpers\TestClock>
     */
