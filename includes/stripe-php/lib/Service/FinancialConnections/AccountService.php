...
namespace DRStripe\Service\FinancialConnections;
...
class AccountService extends \DRStripe\Service\AbstractService
{
     ...
     *
     * @return \DRStripe\Collection<\DRStripe\FinancialConnections\Account>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\FinancialConnections\AccountOwner>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\FinancialConnections\Account
     */
