...
class SubscriptionItemService extends \DRStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \DRStripe\Collection<\DRStripe\SubscriptionItem>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\UsageRecordSummary>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\SubscriptionItem
     */
