...
namespace DRStripe\Service\Reporting;

class ReportTypeService extends \DRStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \DRStripe\Collection<\DRStripe\Reporting\ReportType>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Reporting\ReportType
     */
