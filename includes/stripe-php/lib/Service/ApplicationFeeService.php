...
class ApplicationFeeService extends \DRStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \DRStripe\Collection<\DRStripe\ApplicationFee>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\ApplicationFeeRefund>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\ApplicationFee
     */
