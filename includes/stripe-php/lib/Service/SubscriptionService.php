...
class SubscriptionService extends \DRStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \DRStripe\Collection<\DRStripe\Subscription>
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\SearchResult<\DRStripe\Subscription>
     */
