...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param null|array|\DRStripe\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
     ...
     *
     * @return null|\DRStripe\ErrorObject
     */
     ...
     *
     * @param null|\DRStripe\ErrorObject $error
     */
     ...
     *
     * @return null|array|\DRStripe\Util\CaseInsensitiveArray
     */
     ...
     *
     * @param null|array|\DRStripe\Util\CaseInsensitiveArray $httpHeaders
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \DRStripe\ErrorObject} for possible
     * values.
     *
     * @return null|string
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \DRStripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
