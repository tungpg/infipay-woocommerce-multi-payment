 ...
 * @property null|string|\DRStripe\StripeObject $application ID of the Connect application that created the Order, if any.
 * @property \DRStripe\StripeObject $automatic_tax
 * @property null|\DRStripe\StripeObject $billing_details Customer billing details associated with the order.
 ...
 * @property null|string|\DRStripe\Customer $customer The customer which this orders belongs to.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|(string|\DRStripe\Discount)[] $discounts The discounts applied to the order. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|string $ip_address A recent IP address of the purchaser used for tax reporting and tax location inference.
 * @property \DRStripe\Collection<\DRStripe\LineItem> $line_items A list of line items the customer is ordering. Each line item includes information about the product, the quantity, and the resulting cost. There is a maximum of 100 line items.
 ...
 * @property \DRStripe\StripeObject $payment
 * @property null|\DRStripe\StripeObject $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property null|\DRStripe\StripeObject $shipping_details Customer shipping information associated with the order.
 * @property string $status The overall status of the order.
 * @property \DRStripe\StripeObject $tax_details
...
class Order extends ApiResource
{
     ...
     *
     * @return \DRStripe\Order the canceled order
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Order the reopened order
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Order the submited order
     */
