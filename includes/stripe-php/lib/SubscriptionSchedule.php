 ...
 * @property null|string|\DRStripe\StripeObject $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\DRStripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\DRStripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \DRStripe\StripeObject $default_settings
 ...
 * @property \DRStripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\DRStripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\DRStripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \DRStripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\SubscriptionSchedule the released subscription schedule
     */
