...
namespace DRStripe\BillingPortal;
 ...
 * @property null|string|\DRStripe\StripeObject $application ID of the Connect Application that created the configuration.
 * @property \DRStripe\StripeObject $business_profile
 ...
 * @property \DRStripe\StripeObject $features
 ...
 */
class Configuration extends \DRStripe\ApiResource
{
