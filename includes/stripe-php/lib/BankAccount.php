 ...
 * @property null|string|\DRStripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\DRStripe\Customer $customer The ID of the customer that the bank account is associated with.
