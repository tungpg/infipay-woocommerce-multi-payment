 ...
 * @property \DRStripe\StripeObject $ach_credit_transfer
 * @property \DRStripe\StripeObject $ach_debit
 ...
 * @property \DRStripe\StripeObject $code_verification
 ...
 * @property \DRStripe\StripeObject $multibanco
 * @property null|\DRStripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \DRStripe\StripeObject $p24
 * @property \DRStripe\StripeObject $receiver
 * @property \DRStripe\StripeObject $redirect
 * @property \DRStripe\StripeObject $sepa_credit_transfer
 * @property \DRStripe\StripeObject $sepa_debit
 * @property \DRStripe\StripeObject $sofort
 * @property \DRStripe\StripeObject $source_order
 ...
 * @property \DRStripe\StripeObject $three_d_secure
 ...
 * @property \DRStripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \DRStripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Source the detached source
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection the list of source transactions
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Source the verified source
     */
