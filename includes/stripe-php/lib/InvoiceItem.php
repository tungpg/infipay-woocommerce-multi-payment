 ...
 * @property string|\DRStripe\Customer $customer The ID of the customer who will be billed when this invoice item is billed.
 ...
 * @property null|(string|\DRStripe\Discount)[] $discounts The discounts which apply to the invoice item. Item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|string|\DRStripe\Invoice $invoice The ID of the invoice this invoice item belongs to.
 ...
 * @property \DRStripe\StripeObject $period
 * @property null|\DRStripe\Plan $plan If the invoice item is a proration, the plan of the subscription that the proration was computed for.
 * @property null|\DRStripe\Price $price The price of the invoice item.
 ...
 * @property null|string|\DRStripe\Subscription $subscription The subscription that this invoice item has been created for, if any.
 * @property string $subscription_item The subscription item that this invoice item has been created for, if any.
 * @property null|\DRStripe\TaxRate[] $tax_rates The tax rates which apply to the invoice item. When set, the <code>default_tax_rates</code> on the invoice do not apply to this invoice item.
 * @property null|string|\DRStripe\TestHelpers\TestClock $test_clock ID of the test clock this invoice item belongs to.
