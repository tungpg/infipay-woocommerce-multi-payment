 ...
 * @property \DRStripe\StripeObject $address
 * @property null|\DRStripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\DRStripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \DRStripe\StripeObject $dob
 ...
 * @property null|\DRStripe\StripeObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \DRStripe\StripeObject $registered_address
 * @property \DRStripe\StripeObject $relationship
 * @property null|\DRStripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \DRStripe\StripeObject $verification
 */
class Person extends ApiResource
{
     ...
     *
     * @throws \DRStripe\Exception\BadMethodCallException
     */
