 ...
 * @property null|string|\DRStripe\Price $default_price The ID of the <a href="https://stripe.com/docs/api/prices">Price</a> object that is the default price for this product.
 ...
 * @property null|\DRStripe\StripeObject $package_dimensions The dimensions of this product for shipping purposes.
 ...
 * @property null|string|\DRStripe\TaxCode $tax_code A <a href="https://stripe.com/docs/tax/tax-categories">tax code</a> ID.
...
class Product extends ApiResource
{
     ...
     *
     * @return \DRStripe\SearchResult<Product> the product search results
     */
