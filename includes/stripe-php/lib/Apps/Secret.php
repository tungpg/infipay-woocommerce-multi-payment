 ...
 * @property \DRStripe\StripeObject $scope
 */
class Secret extends \DRStripe\ApiResource
{
     ...
     *
     * @return \DRStripe\Apps\Secret the deleted secret
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Apps\Secret the finded secret
     */
