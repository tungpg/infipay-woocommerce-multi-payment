 ...
 * @property string|\DRStripe\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property string|\DRStripe\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \DRStripe\ApiResource
{
