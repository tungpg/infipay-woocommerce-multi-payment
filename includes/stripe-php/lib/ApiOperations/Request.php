...
trait Request
{
     ...
     *
     * @throws \DRStripe\Exception\InvalidArgumentException if $params exists and is not an array
     */
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            ...
            throw new \DRStripe\Exception\InvalidArgumentException($message);
        }
    }
    ...
    {
        $opts = \DRStripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \DRStripe\ApiRequestor($opts->apiKey, $baseUrl);
