 ...
 * @property \DRStripe\StripeObject[] $discounts The discounts applied to the line item.
 * @property null|\DRStripe\Price $price The price used to generate the line item.
 * @property string|\DRStripe\Product $product <p>The ID of the product for this line item.</p><p>This will always be the same as <code>price.product</code>.</p>
 * @property null|int $quantity The quantity of products being purchased.
 * @property \DRStripe\StripeObject[] $taxes The taxes applied to the line item.
 */
