 ...
 * @property null|\DRStripe\StripeObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\DRStripe\StripeObject $end_user_details Details about the end user.
 ...
 * @property null|\DRStripe\StripeObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property string|\DRStripe\Treasury\Transaction $transaction The Transaction associated with this object.
 */
class OutboundPayment extends \DRStripe\ApiResource
{
     ...
     *
     * @return \DRStripe\Treasury\OutboundPayment the canceled outbound payment
     */
