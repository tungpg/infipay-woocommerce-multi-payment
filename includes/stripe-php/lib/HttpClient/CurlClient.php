...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \DRStripe\Util\RandomGenerator */
     ...
     * @param null|\DRStripe\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\DRStripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\DRStripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
