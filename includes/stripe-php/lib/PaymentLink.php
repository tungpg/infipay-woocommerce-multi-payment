 ...
 * @property \DRStripe\StripeObject $after_completion
 ...
 * @property null|\DRStripe\StripeObject $consent_collection When set, provides configuration to gather active consent from customers.
 * @property string $customer_creation Configuration for Customer creation during checkout.
 * @property \DRStripe\Collection<\DRStripe\LineItem> $line_items The line items representing what is being sold.
 ...
 * @property null|\DRStripe\StripeObject $payment_intent_data Indicates the parameters to be passed to PaymentIntent creation during checkout.
 ...
 * @property null|\DRStripe\StripeObject $shipping_address_collection Configuration for collecting the customer's shipping address.
 * @property \DRStripe\StripeObject[] $shipping_options The shipping rate options applied to the session.
 ...
 * @property null|\DRStripe\StripeObject $subscription_data When creating a subscription, the specified configuration data will be used. There must be at least one line item with a recurring price to use <code>subscription_data</code>.
 * @property \DRStripe\StripeObject $tax_id_collection
 * @property null|\DRStripe\StripeObject $transfer_data The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to.
