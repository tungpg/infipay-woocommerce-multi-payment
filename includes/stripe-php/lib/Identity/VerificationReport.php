 ...
 * @property \DRStripe\StripeObject $document Result from a document check
 * @property \DRStripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \DRStripe\StripeObject $options
 * @property \DRStripe\StripeObject $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \DRStripe\ApiResource
{
