 ...
 * @property null|\DRStripe\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\DRStripe\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property \DRStripe\StripeObject $options
 * @property null|\DRStripe\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|\DRStripe\StripeObject $verified_outputs The user’s verified data.
 */
class VerificationSession extends \DRStripe\ApiResource
{
     ...
     *
     * @return \DRStripe\Identity\VerificationSession the canceled verification session
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Identity\VerificationSession the redacted verification session
     */
