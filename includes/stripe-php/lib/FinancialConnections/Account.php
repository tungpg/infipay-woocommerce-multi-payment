 ...
 * @property null|\DRStripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\DRStripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\DRStripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\DRStripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\DRStripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 */
class Account extends \DRStripe\ApiResource
{
     ...
     *
     * @return \DRStripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\Collection<\DRStripe\FinancialConnections\AccountOwner> list of BankConnectionsResourceOwners
     */
     ...
     * @throws \DRStripe\Exception\ApiErrorException if the request fails
     *
     * @return \DRStripe\FinancialConnections\Account the refreshed account
     */
